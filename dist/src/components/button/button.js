...
var Button = function (_a) {
    var to = _a.to, useIcon = _a.useIcon, children = _a.children, props = __rest(_a, ["to", "useIcon", "children"]);
    var injectedProps = __assign({}, props, { circular: circular ? 1 : 0 });
    if (to) {
        return (React.createElement(Link, __assign({ to: to }, injectedProps), children));
    }
    return React.createElement("button", __assign({}, injectedProps), children);
};
